namespace AutoCodeFirst.Model
{
    ...
    public partial class TrackEvaluation
    {
        ...
        {
            TrackEvaluationComments = new HashSet<TrackEvaluationComment>();
            TrackEvaluationHistories = new HashSet<TrackEvaluationHistory>();
            TrackEvaluationParts = new HashSet<TrackEvaluationPart>();
        }
        ...
        public virtual ICollection<TrackEvaluationComment> TrackEvaluationComments { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<TrackEvaluationHistory> TrackEvaluationHistories { get; set; }

        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<TrackEvaluationPart> TrackEvaluationParts { get; set; }
    }
}
